...
// Enable BBOX selection using Mapbox Draw
...
// Add terrain source with increased extrusion
map.on('load', function () {
    ...
    map.setTerrain({ "source": "mapbox-dem", "exaggeration": 2.0 }); // Increased terrain extrusion

    console.log("3D Terrain Enabled with Southward Orientation");
});

// Listen for user confirmation of BBOX selection
